...
public class HomeFragment_ViewBinding implements Unbinder {
  ...
  public HomeFragment_ViewBinding(HomeFragment target, View source) {
    ...
    target.relative = Utils.findRequiredViewAsType(source, R.id.relative, "field 'relative'", RelativeLayout.class);
    target.toggle = Utils.findRequiredViewAsType(source, R.id.toggle, "field 'toggle'", ImageView.class);
    target.toggle1 = Utils.findRequiredViewAsType(source, R.id.toggle1, "field 'toggle1'", ImageView.class);
    target.scrollView1 = Utils.findRequiredViewAsType(source, R.id.ScrlView, "field 'scrollView1'", ScrollView.class);
  }
