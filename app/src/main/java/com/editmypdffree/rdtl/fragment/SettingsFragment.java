...
import static com.editmypdffree.rdtl.util.Constants.MODIFY_STORAGE_LOCATION_CODE;
...
import static com.editmypdffree.rdtl.util.SettingsOptions.getEnhancementOptions;
...
public class SettingsFragment extends Fragment implements OnItemClickListener {
    ...
    private void changeCompressImage() {
        ...
        MaterialDialog dialog = DialogUtils.getInstance()
                .createCustomDialogWithoutContent(mActivity)
