...
import com.editmypdffree.rdtl.activity.FavouritesActivity;
...
import static com.editmypdffree.rdtl.util.Constants.ADD_IMAGES_KEY;
import static com.editmypdffree.rdtl.util.Constants.ADD_PASSWORD_KEY;
import static com.editmypdffree.rdtl.util.Constants.ADD_PWD;
import static com.editmypdffree.rdtl.util.Constants.ADD_TEXT_KEY;
import static com.editmypdffree.rdtl.util.Constants.ADD_WATERMARK;
import static com.editmypdffree.rdtl.util.Constants.ADD_WATERMARK_KEY;
...
import static com.editmypdffree.rdtl.util.Constants.COMPRESS_PDF_KEY;
import static com.editmypdffree.rdtl.util.Constants.EXCEL_TO_PDF_KEY;
import static com.editmypdffree.rdtl.util.Constants.EXTRACT_IMAGES;
import static com.editmypdffree.rdtl.util.Constants.EXTRACT_IMAGES_KEY;
import static com.editmypdffree.rdtl.util.Constants.EXTRACT_TEXT_KEY;
import static com.editmypdffree.rdtl.util.Constants.HISTORY_KEY;
import static com.editmypdffree.rdtl.util.Constants.IMAGE_TO_PDF_KEY;
import static com.editmypdffree.rdtl.util.Constants.INVERT_PDF_KEY;
import static com.editmypdffree.rdtl.util.Constants.MERGE_PDF_KEY;
import static com.editmypdffree.rdtl.util.Constants.PDF_TO_IMAGES;
import static com.editmypdffree.rdtl.util.Constants.PDF_TO_IMAGES_KEY;
import static com.editmypdffree.rdtl.util.Constants.QR_BARCODE_KEY;
import static com.editmypdffree.rdtl.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static com.editmypdffree.rdtl.util.Constants.REMOVE_PAGES;
import static com.editmypdffree.rdtl.util.Constants.REMOVE_PAGES_KEY;
import static com.editmypdffree.rdtl.util.Constants.REMOVE_PASSWORD_KEY;
...
import static com.editmypdffree.rdtl.util.Constants.REORDER_PAGES_KEY;
import static com.editmypdffree.rdtl.util.Constants.ROTATE_PAGES;
import static com.editmypdffree.rdtl.util.Constants.ROTATE_PAGES_KEY;
import static com.editmypdffree.rdtl.util.Constants.SPLIT_PDF_KEY;
import static com.editmypdffree.rdtl.util.Constants.TEXT_TO_PDF_KEY;
import static com.editmypdffree.rdtl.util.Constants.VIEW_FILES_KEY;
import static com.editmypdffree.rdtl.util.Constants.ZIP_TO_PDF_KEY;
...
//    <font color="#ffffff">    Text To PDF    </font>
