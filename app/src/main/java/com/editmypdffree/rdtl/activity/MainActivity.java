...
import com.editmypdffree.rdtl.providers.fragmentmanagement.FragmentManagement;
...
public class MainActivity extends AppCompatActivity
    ...
    private static final String ONESIGNAL_APP_ID = "f5d71c62-af59-473b-9eb9-85073a7a4d0f";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap icon = BitmapFactory.decodeResource(getResources(),
                R.drawable.ic_hammenu1); //Converting drawable into bitmap
