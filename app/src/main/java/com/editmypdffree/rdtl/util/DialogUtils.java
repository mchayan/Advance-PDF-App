...
import static com.editmypdffree.rdtl.util.Constants.ADD_PASSWORD;
import static com.editmypdffree.rdtl.util.Constants.ADD_WATERMARK;
import static com.editmypdffree.rdtl.util.Constants.REMOVE_PASSWORD;
...
public class DialogUtils {
    ...
    public MaterialDialog.Builder createCustomDialogWithoutContent(Activity activity) {
        return new MaterialDialog.Builder(activity)
                .backgroundColor(Color.parseColor("#4530B3"))
                .positiveColor(Color.parseColor("#FFFFFF"))
                .negativeColor(Color.parseColor("#FFFFFF"))
                .neutralColor(Color.parseColor("#FFCECE"))
                .positiveText(android.R.string.ok)
                .negativeText(android.R.string.cancel);
    }
